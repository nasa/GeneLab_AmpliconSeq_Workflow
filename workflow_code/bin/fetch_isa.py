...
def main():
    ...
    # Check provided OSD is not on the list of Amplicon datasets that can't be autoprocessed
    ...
    if args.osd in not_autoprocessable_OSD_dict:
        sys.exit(f"The specified dataset {args.osd} cannot be be processed with this workflow. \nReason: {not_autoprocessable_OSD_dict[args.osd]}\n")
