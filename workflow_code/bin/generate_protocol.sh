...
PROTOCOL="Data were processed as described in ${PROTOCOL_ID} (https://github.com/nasa/GeneLab_Data_Processing/blob/master/Amplicon/Illumina/Pipeline_GL-DPPD-7104_Versions/${PROTOCOL_ID}.md), using workflow NF_AmpIllumina v1.0.3 (https://github.com/nasa/GeneLab_AmpliconSeq_Workflow/blob/v1.0.3/README.md).
